...
async def access_resource():
    ...
    try:
        ...
        try:
            ...
            print(f"Found {len(resources)} resources: {[resource.uri for resource in resources]}")
        except Exception as e:
            print(f"Expected error listing resources: {str(e)}")
            print("This is expected because the server doesn't support the resources API")
            return
